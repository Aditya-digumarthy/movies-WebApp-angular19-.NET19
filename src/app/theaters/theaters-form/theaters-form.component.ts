...
import { CreateTheatersComponent } from '../create-theaters/create-theaters.component';
...
export class TheatersFormComponent implements OnInit {
  ...
  @Output() postForm = new EventEmitter<TheaterCreationDTO>(); 
  ...
  handleCoordinateSolution(coordinate: Coordinate) {
    this.form.controls.coordinate.setValue(coordinate);
