...
export class MoviesService {
  ...
  public create(movie: MovieCreationDTO) {
    const formData = this.builderFormData(movie);
  ...
  private builderFormData(movie: MovieCreationDTO): FormData {
    ...
    formData.append('actors', JSON.stringify(movie.actors));  // later we can change it to actorsIds
