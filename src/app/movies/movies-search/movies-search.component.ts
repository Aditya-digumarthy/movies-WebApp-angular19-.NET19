...
@Component({
  ...
  imports: [MatFormFieldModule, ReactiveFormsModule, MatInputModule, MatButtonModule, MatCheckboxModule, MatInputModule, MatSelectModule, MoviesListComponent , MatPaginatorModule],
