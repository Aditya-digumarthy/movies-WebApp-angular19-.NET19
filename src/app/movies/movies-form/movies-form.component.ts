...
export class MoviesFormComponent implements OnInit{
  ...
  @Output() postForm = new EventEmitter<MovieCreationDTO>();

  @Input({required : true})  selectedGenres!: MultipleSelectorDTO[]
  @Input({required : true})  nonSelectedGenres!: MultipleSelectorDTO[]

  
  @Input({required : true})  selectedTheaters!: MultipleSelectorDTO[]
  @Input({required : true})  nonSelectedTheaters!: MultipleSelectorDTO[]
